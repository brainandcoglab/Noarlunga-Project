...
ResponseBoxJarA=Screen('GetImage',window2,[ResponseBoxCoords(1,:)],[],[],4);
Env.ResponseOne(QNums)=Screen('MakeTexture',window,ResponseBoxJarA,[]);
ResponseBoxJarB =Screen('GetImage',window2,[ResponseBoxCoords(2,:)],[],[],4);
Env.ResponseTwo(QNums)=Screen('MakeTexture',window,ResponseBoxJarB,[]);
